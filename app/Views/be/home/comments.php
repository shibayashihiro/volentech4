...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>VolenTech | Comments</title>
    ...
    <body class="page-container-bg-solid page-boxed">     
                                    ...
                                    <div class="portlet light form-fit ">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                ...
                                                <span class="caption-subject font-green bold uppercase">Comments Content</span>
                                            </div>                                         
                                        </div>
                                                                    ...
                                                                    ?>
                                                                        <div class='core-value'>                                                                
                                                                            ...
                                                                            <div class='core-value-buttons'>                                                                    
                                                                                <button type="button" class="btn blue btn-sm btn-circle" onclick='editValue(<?php echo $comment["ID"];?>)'><i class='icon-pencil'></i></button>&nbsp;
                                                                                <button type="button" class="btn red btn-sm btn-circle" onclick='deleteValue(<?php echo $comment["ID"];?>)'><i class='icon-trash'></i></button>
                                                                            </div>
                                                                        </div>
                                                                    <?php
                                                                }
                                ...
                                <form action="" class="form-horizontal form-bordered" id='addNewForm'>
                                    <div class="form-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <textarea type='text' id='Title' class='form-control'></textarea>
                                            </div>
                                        </div>    
                                        <div class="form-group">
                                            <label class="control-label col-md-3">Content</label>
                                            <div class="col-md-9">
                                                <textarea type='text' id='Content' class='form-control' rows='6'></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                ...
                                <form action="" class="form-horizontal form-bordered" id='addNewForm'>
                                    <div class="form-body">
                                        <div class="form-group">
                                            <label class="control-label col-md-3">Title</label>
                                            <div class="col-md-9">
                                                <textarea type='text' id='TitleEdit' class='form-control'></textarea>
                                            </div>
                                        </div>    
                                        <div class="form-group">
                                            <label class="control-label col-md-3">Content</label>
                                            <div class="col-md-9">
                                                <textarea type='text' id='ContentEdit' class='form-control' rows='6'></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-md-3">Author</label>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-3">Location</label>
                                            <div class="col-md-9">
                                                <input type="text" id="LocationEdit" class="form-control" />
                                            </div>
                                        </div>
                                    </div>                                                                                                    
                                </form>
        ...
        <script src="<?php echo base_url('assets/layouts/layout3/scripts/pages/home/comments.js');?>" type="text/javascript"></script>
